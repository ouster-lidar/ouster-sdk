...
# set VCPKG_MANIFEST_MODE from corresponding env variable
if(DEFINED ENV{VCPKG_MANIFEST_MODE} AND NOT DEFINED VCPKG_MANIFEST_MODE)
  message(STATUS "Using VCPKG_MANIFEST_MODE from env: $ENV{VCPKG_MANIFEST_MODE}")
  set(VCPKG_MANIFEST_MODE "$ENV{VCPKG_MANIFEST_MODE}"
    CACHE STRING "vcpkg manifest mode")
endif()

...
- `tbb <https://github.com/oneapi-src/oneTBB>`_
...
- `nanobind <https://nanobind.readthedocs.io>`_ == 2.9.2
...
On ``macOS >= 14``, using Homebrew, you should be able to run:
...
.. code:: powershell
   ...
   # install nanobind
   PS > py -m pip install nanobind ninja

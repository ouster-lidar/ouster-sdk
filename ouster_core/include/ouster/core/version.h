...
/** \defgroup ouster_core_version_operators Ouster Core version.h Operators
 * @{
 */
/**
...
inline bool operator==(const Version& u, const Version& v) {
    return u.major == v.major && u.minor == v.minor && u.patch == v.patch && u.stage == v.stage &&
           u.machine == v.machine && u.build == v.build && u.prerelease == v.prerelease;
}

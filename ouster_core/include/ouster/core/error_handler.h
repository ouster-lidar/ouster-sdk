 ...
 */
using error_handler_t = std::function<void(Severity, const std::string& message)>;

/**
 * A default error handler, invoked by a FrameSetSource or osf::Reader when

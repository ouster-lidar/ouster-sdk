 ...
 */
     ...
     */
         ...
         */
            ...
            #define OUSTER_API_DEFINES
            #define OUSTER_API_VAR __declspec( dllexport )

        /**
         * Currently compiling the code requiring the ouster
         * shared library.
         * OUSTER_API_FUNCTION is intentionally empty here: dllimport on function
         * declarations is optional (the linker resolves them from the import lib
         * without it), and adding it breaks inline/template function definitions
         * in headers with C2491.  Only data symbols need dllimport.
         */
        #elif defined(BUILD_SHARED_LIBS_IMPORT)
            #define OUSTER_API_FUNCTION
            #define OUSTER_API_CLASS
            #define OUSTER_API_DEFINES
            #define OUSTER_API_VAR __declspec( dllimport )
        #endif
     ...
     */
         ...
         */
            ...
            #define OUSTER_API_CLASS [[gnu::visibility("default")]]

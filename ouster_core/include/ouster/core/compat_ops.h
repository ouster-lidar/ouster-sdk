...
OUSTER_API_FUNCTION
nonstd::optional<bool> is_directory(const std::string& path  ///< [in] path to check
);
...
OUSTER_API_FUNCTION
std::vector<std::string> files_in_directory(const std::string& path  ///< [in] path to check
);

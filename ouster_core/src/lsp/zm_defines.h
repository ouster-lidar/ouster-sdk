...
namespace sdk {
namespace core {
constexpr size_t C_ZONE_MON_PIXEL_BOUNDS_BYTES = 2 * sizeof(uint16_t);  // 16b near / 16b far
constexpr size_t C_ZONE_MON_MAX_N_COLS = 2048;          // Currently cap suport at 2048
constexpr size_t C_ZONE_MON_MAX_N_ROWS = N_PIXELS_MAX;  // Currently cap suport at 128
...
constexpr size_t C_ZONE_MON_ALL_ZONE_IDS_W = C_ZONE_MON_ZONE_ID_W * C_ZONE_MON_MAX_ACTIVE_ZONES;
constexpr size_t C_ZONE_MON_MODE_W = 2;
constexpr size_t C_ZONE_MON_ALL_MODES_W = C_ZONE_MON_MODE_W * C_ZONE_MON_MAX_ACTIVE_ZONES;

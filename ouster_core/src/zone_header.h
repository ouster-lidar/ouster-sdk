...
struct CacheRenderMetadata {
    ...
    CacheRenderMetadata(const Zrb& zrb, const std::bitset<2048>& valid_col_mask_init,
...
static_assert(sizeof(CacheHeaderInfo) == 39, "CacheHeaderInfo size should be 39 bytes");
static_assert(sizeof(CacheRenderMetadata) == 540, "CacheRenderMetadata size should be 540 bytes");

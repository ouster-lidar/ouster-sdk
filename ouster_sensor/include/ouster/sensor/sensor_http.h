...
class OUSTER_API_CLASS SensorHttp {
   ...
   public:
    ...
    virtual std::string get_config_params(
        bool active, int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
     ...
     */
    OUSTER_API_FUNCTION
    virtual void set_config_param(const std::string& key, const std::string& value,
     ...
     */
    OUSTER_API_FUNCTION
    virtual void set_user_data(const std::string& data, bool keep_on_config_delete = true,
                               int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
     ...
     */
    OUSTER_API_FUNCTION
    virtual void set_static_ip(const std::string& ip_address,
                               int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
     ...
     */
    OUSTER_API_FUNCTION
    virtual void set_static_ip(const std::string& ip_address, const std::string& gateway_address,
                               int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
    ...
    virtual std::vector<uint8_t> get_zone_monitor_config_zip(
        bool staged = false, int timeout_sec = LONG_HTTP_REQUEST_TIMEOUT_SECONDS) const = 0;
     ...
     */
    OUSTER_API_FUNCTION
    static std::string get_firmware_version_string(
        const std::string& hostname, int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS);
     ...
     */
    OUSTER_API_FUNCTION
    static ouster::sdk::core::Version get_firmware_version(
        const std::string& hostname, int timeout_sec = SHORT_HTTP_REQUEST_TIMEOUT_SECONDS);

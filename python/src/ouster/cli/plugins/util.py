...
from ouster.cli.core.util import md5file
...
def download_sample_data(url: str,
    ...
    URL is expected to point to a zipfile containing exactly one pcap file and
    one json file.
    """
...
def convert_metadata_to_legacy(meta) -> None:
    ...
    with open(meta) as json:
        ...
        click.echo(client.convert_to_legacy(json.read()))

...
This module is generated from the C++ code and not meant to be used directly.
    ...
    py::class_<guessed_ports, std::shared_ptr<guessed_ports>>(m, "guessed_ports")
        .def(py::init<>())
    ...
    py::class_<stream_data, std::shared_ptr<stream_data>>(m, "stream_data")
        ...
        .def_readonly("payload_size", &stream_data::payload_size)
        .def_readonly("fragments_in_packet", &stream_data::fragments_in_packet)
        .def_readonly("ip_version", &stream_data::ip_version);
    ...
    m.def("get_stream_info", &get_stream_info);

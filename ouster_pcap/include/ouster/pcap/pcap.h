...
struct OUSTER_DEPRECATED_MSG("PcapPacketSource",
                             OUSTER_DEPRECATED_LAST_SUPPORTED_1_0) OUSTER_API_CLASS PacketInfo {
...
class OUSTER_DEPRECATED_MSG("PcapPacketSource",
                            OUSTER_DEPRECATED_LAST_SUPPORTED_1_0) OUSTER_API_CLASS PcapReader {
   protected:
 ...
 */
class OUSTER_DEPRECATED_MSG("RecordHandle",
                            OUSTER_DEPRECATED_LAST_SUPPORTED_1_0) OUSTER_API_CLASS PcapWriter {
   public:
    /**
     ...
     */
    OUSTER_API_FUNCTION
    void write_packet(const uint8_t* buf, size_t buf_size, const std::string& src_ip,

...
int main(int argc, char** argv) {
    ...
    const auto xyz_lut =
        ouster::make_xyz_lut(W, H, OS1::range_unit, info.beam_azimuth_angles,
                             info.beam_altitude_angles);

    auto vh = viz::init_viz(W, H, &xyz_lut, info.prod_line);
    ...
    auto batch_and_update = OS1::batch_to_iter<ouster::LidarScan::iterator>(
        W, H, ouster::LidarScan::Pixel::empty_val(), &ouster::LidarScan::pixel,

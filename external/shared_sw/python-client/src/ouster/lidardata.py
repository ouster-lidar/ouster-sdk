...
class OsLidarData:
    ...
    def _view(self, offset, data_type):
        """
    ...
    def make_pixel_range_view(self):
        """
        ...
        return np.lib.stride_tricks.as_strided(
            temp_view, shape=(self._pf.pixels_per_column, self._pf.columns_per_packet),
            strides=(self._pixel_bytes, self._column_bytes))
    
    def make_pixel_reflectivity_view(self):
        """
    ...
    def make_pixel_signal_view(self):
        """
    ...
    def make_pixel_noise_view(self):
        """
    ...
    def make_col_timestamp_view(self):
        """
        ...
        return np.lib.stride_tricks.as_strided(
            temp_view, shape=(self._pf.columns_per_packet,),
            strides=(self._column_bytes,))
    
    def make_col_encoder_count_view(self):
        """
    ...
    def make_col_measurement_id_view(self):
        """
    ...
    def make_col_frame_id_view(self):
        """
    ...
    def make_col_valid_view(self):
        ...
        """
        data_type = np.uint32
        temp_view = self._view(self._col_preamble_size + self._pf.pixels_per_column * self._pixel_bytes, data_type)
        return np.lib.stride_tricks.as_strided(
            temp_view, shape=(self._pf.columns_per_packet,),
            strides=(self._column_bytes,))
